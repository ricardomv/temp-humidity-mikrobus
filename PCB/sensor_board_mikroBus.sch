...
LIBS:74xx
LIBS:Connector
LIBS:sensor_board_mikroBus_v1.1-cache
EELAYER 26 0
EELAYER END
...
$EndComp
$Comp
L header:HEADER_M_2.54MM_1R8P_ST_AU_PTH P1
U 1 1 560DC55D
P 7425 1200
F 0 "P1" H 7425 1650 40  0000 C CNN
F 1 "HEADER_M_2.54MM_1R8P_ST_AU_PTH" V 7525 1200 40  0001 C CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x08_P2.54mm_Vertical" H 7425 1200 60  0001 C CNN
...
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x08_P2.54mm_Vertical" H 9850 1200 60  0001 C CNN
...
60 30 52 B0 2A 30 18 29 FF 0F E5 FF 6E A6 18 EE 8C 88 00 00 00 00 49 45 4E 44 AE 42 60 82 
EndData
$EndBitmap
Wire Wire Line
	10075 1550 10000 1550
Wire Wire Line
	7200 1550 7075 1550
Wire Wire Line
	7200 1450 7275 1450
...
$Comp
L connector:Molex_0475710001 J1
U 1 1 5BF9751C
P 7500 2900
F 0 "J1" H 7778 2897 60  0000 L CNN
F 1 "Molex_0475710001" H 7778 2791 60  0000 L CNN
F 2 "104031-0811:MOLEX_104031-0811" H 7500 3000 60  0001 C CNN
...
U 1 1 5BF97A10
P 7450 3750
F 0 "#PWR0101" H 7450 3500 50  0001 C CNN
...
Text GLabel 7150 3200 0    40   Input ~ 0
CS
Text GLabel 7150 3100 0    40   Input ~ 0
MOSI
Text GLabel 7150 2900 0    40   Input ~ 0
SCK
...
U 1 1 5BF9B69A
P 6650 3000
F 0 "#PWR0102" H 6650 2960 30  0001 C CNN
F 1 "+3.3V" H 6650 3125 30  0000 C CNN
...
U 1 1 5BF9CDDA
P 6050 2700
F 0 "#PWR0104" H 6050 2660 30  0001 C CNN
F 1 "+3.3V" H 6050 2825 30  0000 C CNN
...
U 1 1 5BF9CE7B
P 5900 2850
F 0 "C1" H 5978 2888 40  0000 L CNN
F 1 "10uF" H 5978 2812 40  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 5900 2850 60  0001 C CNN
...
U 1 1 5BF9CEC3
P 6200 2850
F 0 "C2" H 6278 2888 40  0000 L CNN
F 1 "100nF" H 6278 2812 40  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 6200 2850 60  0001 C CNN
...
Wire Wire Line
	6050 2750 6200 2750
Text GLabel 5400 2600 0    40   Input ~ 0
CS
$Comp
L power:GND #PWR0106
U 1 1 5BF9EBB6
...
U 1 1 5BF9EC1F
P 5400 2800
F 0 "R1" V 5362 2868 40  0000 L CNN
F 1 "100k" V 5438 2868 40  0000 L CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 5400 2800 60  0001 C CNN
...
U 1 1 5BF9F7C4
P 6450 2350
F 0 "#PWR0107" H 6450 2100 50  0001 C CNN
...
U 1 1 5BF9F800
P 6650 2350
F 0 "R2" H 6650 2168 40  0000 C CNN
F 1 "100k" H 6650 2244 40  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 6650 2350 60  0001 C CNN
...
U 1 1 5BFA0197
P 7150 2450
F 0 "#PWR0108" H 7150 2300 50  0001 C CNN
...
Wire Wire Line
	6850 2350 7150 2350
Text GLabel 6950 2350 1    40   Input ~ 0
INT
$Comp
L Analog_ADC:MCP3201 U1
U 1 1 5BFA2067
P 7400 4650
F 0 "U1" H 7600 4400 50  0000 C CNN
F 1 "MCP3201" H 7600 4300 50  0000 C CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 8150 4300 50  0001 C CNN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/21290D.pdf" H 8200 4550 50  0001 C CNN
	1    7400 4650
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5BFA22ED
P 7450 5800
F 0 "U2" H 7650 5550 50  0000 C CNN
F 1 "MCP3201" H 7650 5450 50  0000 C CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 8200 5450 50  0001 C CNN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/21290D.pdf" H 8250 5700 50  0001 C CNN
	1    7450 5800
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5BFA4013
P 7300 4950
F 0 "#PWR05" H 7300 4700 50  0001 C CNN
...
U 1 1 5BFA5622
P 7350 6100
F 0 "#PWR06" H 7350 5850 50  0001 C CNN
...
Text GLabel 7300 4350 1    50   Input ~ 0
Vref
Text GLabel 7350 5500 1    50   Input ~ 0
Vref
$Comp
L power:+3.3V #PWR07
U 1 1 5BFA575D
P 7500 4350
F 0 "#PWR07" H 7500 4310 30  0001 C CNN
F 1 "+3.3V" H 7500 4475 30  0000 C CNN
...
U 1 1 5BFA57A7
P 7550 5500
F 0 "#PWR08" H 7550 5460 30  0001 C CNN
F 1 "+3.3V" H 7550 5625 30  0000 C CNN
F 2 "" H 7550 5500 60  0000 C CNN
F 3 "" H 7550 5500 60  0000 C CNN
	1    7550 5500
	1    0    0    -1  
$EndComp
Text GLabel 7900 4550 2    40   Input ~ 0
SCK
Text GLabel 7900 4650 2    40   Input ~ 0
MISO
Text GLabel 7950 5900 2    40   Input ~ 0
PWM
Text GLabel 7950 5700 2    40   Input ~ 0
SCK
...
U 1 1 5BFA94C1
P 6050 5650
F 0 "#PWR011" H 6050 5610 30  0001 C CNN
F 1 "+3.3V" H 6050 5775 30  0000 C CNN
...
U 1 1 5BFA94CD
P 5900 5800
F 0 "C4" H 5978 5838 40  0000 L CNN
F 1 "10uF" H 5978 5762 40  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 5900 5800 60  0001 C CNN
...
U 1 1 5BFA94D4
P 6200 5800
F 0 "C6" H 6278 5838 40  0000 L CNN
F 1 "1uF" H 6278 5762 40  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 6200 5800 60  0001 C CNN
...
U 1 1 5BFAB535
P 6050 4450
F 0 "#PWR09" H 6050 4410 30  0001 C CNN
F 1 "+3.3V" H 6050 4575 30  0000 C CNN
...
U 1 1 5BFAB53B
P 6050 4750
F 0 "#PWR010" H 6050 4500 50  0001 C CNN
...
U 1 1 5BFAB541
P 5900 4600
F 0 "C3" H 5978 4638 40  0000 L CNN
F 1 "10uF" H 5978 4562 40  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 5900 4600 60  0001 C CNN
...
U 1 1 5BFAB548
P 6200 4600
F 0 "C5" H 6278 4638 40  0000 L CNN
F 1 "1uF" H 6278 4562 40  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 6200 4600 60  0001 C CNN
...
Wire Wire Line
	6050 4500 6200 4500
$Comp
L MCP1501-SOT23:MCP1501-SOT-23 U3
U 1 1 5BFAE05B
P 3800 5150
F 0 "U3" H 3850 5275 50  0000 C CNN
F 1 "MCP1501-SOT-23" H 3850 5184 50  0000 C CNN
...
U 1 1 5BFAF529
P 4450 5150
F 0 "#PWR015" H 4450 5000 50  0001 C CNN
...
Wire Wire Line
	4450 5150 4450 5250
$Comp
L HIH-5030-001:HIH-5030-001 U4
U 1 1 5BFB5890
P 3650 2950
F 0 "U4" H 3555 3517 50  0000 C CNN
F 1 "HIH-5030-001" H 3555 3426 50  0000 C CNN
F 2 "HIH-5030-001:HONEYWELL_HIH-5030-001" H 3650 2950 50  0001 L BNN
F 3 "Housed Sensor Honeywell Sensing" H 3650 2950 50  0001 L BNN
F 4 "HIH-5030-001" H 3650 2950 50  0001 L BNN "Field4"
F 5 "None" H 3650 2950 50  0001 L BNN "Field5"
F 6 "Unavailable" H 3650 2950 50  0001 L BNN "Field6"
F 7 "Honeywell Sensing" H 3650 2950 50  0001 L BNN "Field7"
F 8 "Sensor: humidity sensor; Range: 0÷100% RH; ±3%; 2.7÷5.5VDC" H 3650 2950 50  0001 L BNN "Field8"
	1    3650 2950
	1    0    0    -1  
$EndComp
$Comp
L AD592BN:AD592BN U5
U 1 1 5BFB5B08
P 3900 4000
F 0 "U5" H 3900 4370 50  0000 C CNN
F 1 "AD592BN" H 3900 4279 50  0000 C CNN
F 2 "AD592BN:TO127P520X660-3P" H 3900 4000 50  0001 L BNN
F 3 "Current Output - Precision Ic Temperature Transducer" H 3900 4000 50  0001 L BNN
F 4 "Unavailable" H 3900 4000 50  0001 L BNN "Field4"
F 5 "Analog Devices" H 3900 4000 50  0001 L BNN "Field5"
F 6 "TO-92 Analog Devices" H 3900 4000 50  0001 L BNN "Field6"
F 7 "None" H 3900 4000 50  0001 L BNN "Field7"
F 8 "AD592BN" H 3900 4000 50  0001 L BNN "Field8"
	1    3900 4000
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5BFB5D66
P 5000 4200
F 0 "#PWR019" H 5000 3950 50  0001 C CNN
...
U 1 1 5BFBB6B7
P 4800 4200
F 0 "R4" H 4800 4018 40  0000 C CNN
F 1 "2k" H 4800 4094 40  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 4800 4200 60  0001 C CNN
...
U 1 1 5BFBBA1C
P 4300 3050
F 0 "R3" V 4338 2982 40  0000 R CNN
F 1 "65k" V 4262 2982 40  0000 R CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 4300 3050 60  0001 C CNN
...
U 1 1 5BFA6713
P 4750 5350
F 0 "#PWR022" H 4750 5100 50  0001 C CNN
...
U 1 1 5BFA6746
P 4750 5250
F 0 "C8" H 4828 5288 40  0000 L CNN
F 1 "2.2uF" H 4828 5212 40  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 4750 5250 60  0001 C CNN
...
U 1 1 5BFA691B
P 2850 5550
F 0 "#PWR020" H 2850 5300 50  0001 C CNN
...
U 1 1 5BFA6921
P 2850 5450
F 0 "C7" H 2928 5488 40  0000 L CNN
F 1 "2.2uF" H 2928 5412 40  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 2850 5450 60  0001 C CNN
...
U 1 1 5BFA82DE
P 2850 5150
F 0 "R5" H 2850 4968 40  0000 C CNN
F 1 "50R" H 2850 5044 40  0000 C CNN
F 2 "Resistor_SMD:R_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 2850 5150 60  0001 C CNN
F 3 "" H 2850 5150 60  0000 C CNN
	1    2850 5150
	0    -1   -1   0   
$EndComp
Text GLabel 7900 4750 2    40   Input ~ 0
TX
$EndSCHEMATC
